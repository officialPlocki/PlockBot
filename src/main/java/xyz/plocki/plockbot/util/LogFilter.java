...
public class LogFilter implements Filter {
    ...
    public Filter.Result checkMessage(String message) {
        if (message.contains("Disconnecting") || message.contains("com.mojang.authlib.GameProfile") || message.contains("java.net.SocketException") || message.contains("java.io.IOException")) {
            return Result.DENY;
        }
